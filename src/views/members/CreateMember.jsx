...
export default function CreateMember() {
  ...
  const getData = async () => {
    try {
      ...
      setMembershipPlans(res.data.records);
      console.log("Membership Plans Data", res.data.records);
    } catch (error) {
      return error;
    }
  };
  ...
  return (
    <div className="mt-5">
      <PageTitle classes={"mb-5"} title={"Crear Miembro"} />
      ...
      <div className="bg-white px-4 py-10 rounded-lg">
        ...
        <form onSubmit={onSubmit}>
          <div className="flex flex-wrap items-center mb-4">
            ...
            <div className="basis-full sm:basis-1/2 xl:basis-1/3 px-2 mb-4">
              <label htmlFor="dateOfBirth" className="font-medium w-full mb-3">
                Fecha de Nacimiento:
              </label>
              <input
                type="date"
